<table class="table table-borderless table-hover text-center dataTable no-footer" id="myRecords" role="grid" aria-describedby="emerdt_info">
	<thead>
		<tr role="row">
...
<div class="dataTables_info" id="parityt_info" role="status" aria-live="polite">
</div>