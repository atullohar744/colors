		...
		<div class="container-scroller">
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				...
				<ul class="nav">
					...
					<li class="nav-item menu-items">
						<a class="nav-link" href="{{#server_url#}}pricing"> <span class="menu-icon"> <i class="mdi mdi-currency-inr"></i> </span> <span class="menu-title">Pricing</span> </a>
					</li>
					<li class="nav-item menu-items">
						<a class="nav-link" href="{{#server_url#}}numbers"> <span class="menu-icon"> <i class="mdi mdi-numeric"></i> </span> <span class="menu-title">Numbers</span> </a>
					</li>
					<li class="nav-item menu-items">
						<a class="nav-link" href="{{#server_url#}}manager/dresult"> <span class="menu-icon"> <i class="mdi mdi-numeric"></i> </span> <span class="menu-title">Declare Result</span> </a>
					</li>
					<li class="nav-item menu-items">
						<a class="nav-link" href="{{#server_url#}}manager/withdrwal"> <span class="menu-icon"> <i class="mdi mdi-currency-inr"></i> </span> <span class="menu-title">Withdraw Request</span></a>
					</li>
					<li class="nav-item menu-items">
						<a class="nav-link" href="{{#server_url#}}manager/rewards"> <span class="menu-icon"> <i class="mdi mdi-numeric"></i> </span> <span class="menu-title">Rewards</span> </a>
					</li>
					<li class="nav-item menu-items">
					...
					{{if $smarty.session.$session.usertype eq 'Administrator'}}
					<li class="nav-item menu-items">
