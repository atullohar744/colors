    function confirmOrder(id){
        if(id){
            $.ajax({
    			url: base + 'inc/ajax.php?mode=confirmOrder',
    			type: 'post',
    			data: {id: id, ajax: true},
    			success: function(response){ 
    				resetSearchPaging('bookings');
    			}
    		});
        }
    ...
    function cancelOrder(id){
        if(id){
            $.ajax({
    			url: base + 'inc/ajax.php?mode=cancelOrder',
    			type: 'post',
    			data: {id: id, ajax: true},
    			success: function(response){ 
    				resetSearchPaging('bookings');
    ...
    function completeOrder(id){
        if(id){
            $.ajax({
    			url: base + 'inc/ajax.php?mode=completeOrder',
    			type: 'post',
    			data: {id: id, ajax: true},
    			success: function(response){ 
    				resetSearchPaging('bookings');
