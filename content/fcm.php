...
class FCM {
	...
	public function send_notification($row = array()) {
		global $server_url;
		opendb();
		...
		$arrayToSend = array('to' => "/topics/all", 'notification' => $notification, 'priority' => 'high', 'data' => array('id' => $row['id'],'videopath' => $row['videopath']));
